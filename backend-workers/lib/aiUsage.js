...
// role exactly like backend/lib/estimateStore.js.
//
...
//
// Workers port of backend/lib/aiUsage.js: env vars arrive as the `env`
// parameter (Workers bindings) instead of module-level process.env reads.
// Required bindings (already set for other endpoints):
//   SUPABASE_URL
//   SUPABASE_SERVICE_ROLE_KEY

// Owner-tunable daily caps per endpoint. PROVISIONAL numbers — tune against
// real usage in the Groq console / Workers logs. Rationale for the defaults:
...
async function enforceDailyCap(env, userId, endpoint) {
