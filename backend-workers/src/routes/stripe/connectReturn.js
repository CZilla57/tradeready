// GET /api/stripe/connect-return — Workers port of
// backend/lib/stripe/connectReturn.js.
// Landing page Stripe redirects to after the Connect onboarding form.
...
//
// NOTE: like the source, this handler deliberately has no method check and no
// CORS — it is a human-facing HTML page, not an API.

export function connectReturnHandler(c) {
