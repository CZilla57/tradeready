...
import { portalRequestHandler } from './routes/estimate/portalRequest.js';
import { portalManageHandler } from './routes/estimate/portalManage.js';
...
app.all('/api/estimate/portal-request', portalRequestHandler);
app.all('/api/estimate/portal-manage', portalManageHandler);
